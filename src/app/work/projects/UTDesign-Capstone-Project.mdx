...
summary: "• Built a **back-end focused containerized data pipeline** leveraging **Docker, Kafka, & Mage.ai** – orchestrating batch/streaming data ingestion from **Kafka topics** into a structured **SQLite** database for developer analysis and manipulation
